                                            ...
                                            <div class="col text-truncate">
                                                <div class="row">
                                                    ...
                                                    <div class="d-none d-lg-flex col-lg-2">
                                                        <div class="text-truncate" data-tooltip="true" title="{{ $project->created_at->tz(Auth::user()->timezone ?? config('app.timezone'))->format(__('Y-m-d') . ' H:i:s') }}">{{ $project->created_at->diffForHumans() }}</div>
                                                    </div>
                                                </div>
                                            </div>
