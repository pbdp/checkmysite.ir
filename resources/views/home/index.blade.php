    ...
    <div class="bg-base-0 position-relative pt-5 pt-sm-6 pb-5 pb-md-7 overflow-hidden">
        <div class="row d-none d-lg-flex position-absolute top-0 right-0 bottom-0 left-0">
            ...
            <div class="col-6">
                ...
                <img src="{{ (config('settings.dark_mode') == 1 ? asset('images/hero_dark.png') : asset('images/hero.png')) }}" class="position-absolute bottom-0 shadow-lg border-top-left-radius-2xl border-top-right-radius-2xl {{ (__('lang_dir') == 'rtl' ? 'right-12' : 'left-12') }}" data-theme-dark="{{ asset('images/hero_dark.png') }}" data-theme-light="{{ asset('images/hero.png') }}" data-theme-target="src" style="width: 80rem; height: 29.8125rem;" alt="{{ config('settings.title') }}">
            </div>
        </div>
